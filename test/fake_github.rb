...
# @todo #2041:60min Move the rest of the tests onto this server.
#  Twenty six files under `test/` still build their GitHub with
#  `stub_request` and `stub_github`, one thousand two hundred and thirty six
