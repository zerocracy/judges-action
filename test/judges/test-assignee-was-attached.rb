...
class TestAssigneeWasAttached < Jp::Test
  ...
  def test_find_assigned_events_for_issues
    ...
    stub_github(
      ...
      body: [
        {
          id: 1110, actor: { login: 'user80', id: 80, type: 'User' },
        ...
        },
        {
          ...
          event: 'assigned', created_at: Time.parse('2025-05-31 17:59:08 UTC'),
          assignee: { login: 'user2', id: 422, type: 'User' },
          assigner: { login: 'user', id: 411, type: 'User' }
        },
        {
          id: 1376, actor: { login: 'user2', id: 422, type: 'User' },
          event: 'referenced', commit_id: '4621af032170f43d',
          commit_url: 'https://api.github.com/repos/foo/foo/commits/4621af032170f43d',
          created_at: Time.parse('2025-05-31 19:57:50 UTC')
        }
      ]
    )
    fb = Factbase.new
    fb.with(_id: 1, what: 'issue-was-opened', repository: 42, issue: 44, where: 'github')
      ...
      .with(_id: 4, what: 'issue-was-closed', repository: 42, issue: 45, where: 'gitlab')
      .with(_id: 5, what: 'issue-was-opened', repository: 42, issue: 47, where: 'github')
      .with(_id: 6, what: 'issue-was-assigned', repository: 42, issue: 47, where: 'github',
            issue_event_id: 1110, when: Time.parse('2025-05-30T15:00:00Z'), who: 80, assigner: 70)
    load_it('assignee-was-attached', fb)
    assert_equal(8, fb.all.size)
    assert_equal(3, fb.picks(what: 'issue-was-opened').size)
    ...
    assert(fb.one?(what: 'issue-was-assigned', repository: 42, issue: 45, where: 'github',
                   issue_event_id: 608, when: Time.parse('2025-05-30 17:59:08 UTC'),
                   who: 422, assigner: 411))
    assert(fb.one?(what: 'issue-was-assigned', repository: 42, issue: 47, where: 'github',
                   issue_event_id: 1110, when: Time.parse('2025-05-30T15:00:00Z'),
                   who: 80, assigner: 70))
    assert(fb.one?(what: 'issue-was-assigned', repository: 42, issue: 47, where: 'github',
                   issue_event_id: 1208, when: Time.parse('2025-05-31 17:59:08 UTC'),
                   who: 422, assigner: 411))
  end
end
