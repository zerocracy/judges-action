...
class TestGithubEvents < Jp::Test
  ...
  def test_ignores_events_from_configured_bot_users
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
    ...
    stub_github(
      ...
      body: [
        ...
        },
        {
          id: '11002',
          type: 'IssuesEvent',
          actor: { id: 1002, login: 'rultor' },
          repo: { id: 42, name: 'foo/foo' },
          payload: {
            action: 'opened',
            issue: { number: 1 }
          },
          created_at: '2025-01-01 12:01:00 UTC'
        },
        {
          id: '11003',
          type: 'PushEvent',
          actor: { id: 1003, login: 'human-user' },
          repo: { id: 42, name: 'foo/foo' },
          payload: {
            push_id: 124,
            ref: 'refs/heads/master',
          ...
          created_at: '2025-01-01 12:02:00 UTC'
        }
      ]
    )
    stub_github('https://api.github.com/user/1001', body: { id: 1001, login: '0pdd' })
    stub_github('https://api.github.com/user/1002', body: { id: 1002, login: 'rultor' })
    stub_github('https://api.github.com/user/1003', body: { id: 1003, login: 'human-user' })
    stub_github(
      'https://api.github.com/repos/foo/foo/commits/abc123/pulls?per_page=100',
      body: []
    )
    stub_github(
      'https://api.github.com/repos/foo/foo/commits/def456/pulls?per_page=100',
      body: []
    )
    fb = Factbase.new
    ...
    assert(fb.none?(who: 1001))
    assert(fb.none?(who: 1002))
  end

  def test_processes_events_when_no_bots_configured
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
    ...
    stub_github(
      'https://api.github.com/repos/foo/foo',
      body: { id: 42, name: 'foo', full_name: 'foo/foo', default_branch: 'master', owner: { id: 9999 } }
    )
    stub_github(
      'https://api.github.com/repos/foo/foo/commits/ghi789/pulls?per_page=100',
      body: []
    )
    fb = Factbase.new
