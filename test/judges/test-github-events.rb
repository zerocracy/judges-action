...
class TestGithubEvents < Jp::Test
  ...
  def test_skip_tag_event_on_unknown_ref_type
    WebMock.disable_net_connect!
    rate_limit_up
    stub_event(
      {
  ...
  def test_adds_only_approved_review_events
    WebMock.disable_net_connect!
    rate_limit_up
    stub_request(:get, 'https://api.github.com/repos/foo/foo').to_return(
      body: { id: 42, full_name: 'foo/foo' }.to_json, headers: {
  ...
  def test_skip_pr_review_event_on_unknown_action
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_release_contributors_no_tag_with_id
    WebMock.disable_net_connect!
    rate_limit_up
    stub_event(
      {
  ...
  def test_release_contributors_no_tag_no_id
    WebMock.disable_net_connect!
    rate_limit_up
    stub_event(
      {
  ...
  def test_skip_release_event_on_unknown_action
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_logs_forbidden_repo_access_error_only_once
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
      ...
      body: [
        {
          ...
          actor: { id: 43, login: 'yegor256' },
          repo: { id: 42, name: 'foo/foo' },
          payload: { push_id: 2413, ref: 'refs/heads/master', head: 'f5d59b035' },
          created_at: '2025-05-05 19:04:16 UTC'
        },
        {
          id: '11111',
          type: 'PushEvent',
    ...
    fb = Factbase.new
    buf = Loog::Buffer.new
    load_it('github-events', fb, loog: buf)
    assert_equal(
      1, buf.to_s.scan("doesn't have access").size,
      'a forbidden repository cannot log its access error more than once per run'
    )
  end
  ...
  def test_push_event_non_owner_sets_owner_none
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_adds_opened_pull_request_event
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_skip_fill_up_event_on_given_uniques
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_skip_duplicate_opened_pr_without_who
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_skip_pr_event_on_unknown_action
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_prevents_duplicate_facts_on_pr_closures
    WebMock.disable_net_connect!
    rate_limit_up
    stub_event(
      {
  ...
  def test_skip_issue_comment_on_unknown_action
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_stops_scanning_above_max_events
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_stops_scanning_below_latest_event_id
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_finished_scanning_saves_latest_id
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_handles_pr_event_with_old_repo_name
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_rescues_forbidden_on_closed_pr_lookup
    WebMock.disable_net_connect!
    rate_limit_up
    stub_event(
      {
  ...
  def test_rescues_deprecated_on_closed_pr_lookup
    WebMock.disable_net_connect!
    rate_limit_up
    stub_event(
      {
  ...
  def test_rescues_forbidden_on_closed_pr_reviews
    WebMock.disable_net_connect!
    rate_limit_up
    stub_event(
      {
  ...
  def test_closed_pr_event_with_nil_additions
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_closed_pr_with_review_and_suggestions
    WebMock.disable_net_connect!
    rate_limit_up
    stub_github(
      'https://api.github.com/repos/foo/foo',
  ...
  def test_release_event_with_identical_compare_response
    WebMock.disable_net_connect!
    rate_limit_up
    stub_event(
      {
    ...
    stub_github('https://api.github.com/repos/foo/foo/commits?per_page=1', body: [{ sha: 'abc123def456' }])
    stub_github(
      'https://api.github.com/repos/foo/foo/compare/abc123def456...1.0.2?per_page=100',
      body: { status: 'identical', total_commits: 0, commits: [], files: [] }
    )
    stub_github('https://api.github.com/user/8086956', body: { login: 'rultor', id: 8_086_956 })
    fb = Factbase.new
    load_it('github-events', fb)
    f = fb.query('(and (eq repository 42) (eq what "release-published"))').each.to_a
    assert_equal(1, f.count)
    assert_equal([0], f.first[:commits])
    assert_nil(f.first[:last_commit])
  end
  ...
  def test_release_rescues_deprecated_compare
    WebMock.disable_net_connect!
    rate_limit_up
    stub_event(
      {
