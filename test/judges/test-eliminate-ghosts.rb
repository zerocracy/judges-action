...
class TestEliminateGhosts < Jp::Test
  ...
  def test_process_unique_users_first_and_set_stale_property_later_for_other_facts
    ...
    fb.with(_id: 1, where: 'github', who: 111, what: 'something-a')
      ...
      .with(_id: 10, where: 'github', who: 555, what: 'something-j', stale: 'user #555')
      .with(_id: 11, where: 'github', who: 555, what: 'something-k', stale: 'user #555')
      .with(_id: 12, where: 'github', who: 555, what: 'something-l', stale: 'user #555')
    load_it('eliminate-ghosts', fb)
